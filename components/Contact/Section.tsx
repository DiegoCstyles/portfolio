            ...
            <div className='flex'>
              <div className=" justify-between">
                <div className="flex justify-start mb-4">
                  <label htmlFor="name" className="block text-center mt-1 text-gray-700 dark:text-white text-sm font-medium mb-2">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex mb-4">
                  <label htmlFor="email" className="block text-center mt-1 text-gray-700 dark:text-white text-sm font-medium mb-2">
                    Email
                  </label>
                  <input
                    type="email"
